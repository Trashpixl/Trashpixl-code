                    ...
                    if (z1 < z2) {
                        for (zCount in z1..z2) {
                            ...
                            val placeToPutTheBlock =
                                    Location(
                                            w,
                                            xBuildCount.toDouble(),
                                            yBuildCount.toDouble(),
                                            zBuildCount.toDouble()
                                    )
                            val placeToGetTheBlock =
                                    Location(
                                            w,
                                            xCount.toDouble(),
                                            yCount.toDouble(),
                            ...
                            w.getBlockAt(placeToPutTheBlock).type =
                                    w.getBlockAt(placeToGetTheBlock).type
                        }
                    }
                    if (z1 > z2) {
                        for (zCount in z2..z1) {

...
class OnCommandFireTrap:
        CommandExecutor { // creating the class death and implementing the listener
            ...
            override fun onCommand(
                ...
                if (Bukkit.getServer().onlinePlayers.size == Variable.numberOfPlayerBridgeRace) {//todo add the thing to set the map on fire
                    ...
                    var offsetSpawn = 0
                    copyGame("fireTrap") // copy the game todo add the name
